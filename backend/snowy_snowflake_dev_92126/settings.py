"""
Django settings for snowy_snowflake_dev_92126 project.
...
ROOT_URLCONF = 'snowy_snowflake_dev_92126.urls'
...
WSGI_APPLICATION = 'snowy_snowflake_dev_92126.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "snowy_snowflake_dev_92126 API",
    "DESCRIPTION": "API documentation for snowy_snowflake_dev_92126 App",
    "VERSION": "v1",
}
