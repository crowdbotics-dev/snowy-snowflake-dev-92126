...
## Project Structure
    ...
    ├── snowy_snowflake_dev_92126  # Django project configurations
...
1. Clone this repo and `cd snowy_snowflake_dev_92126`
...
2. Clone this repo and `cd snowy_snowflake_dev_92126`
